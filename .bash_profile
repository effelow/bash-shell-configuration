...
#       2.0  Client-individual configs
#       2.1  Client-specific configs
#       2.2  Mac-specific configs
#       2.3  Linux-based configs
...
#   PATH
#   ------------------------------------------------------------
    # Add Homebrew as default cause `/usr/local/bin` and User `~/bin` to the `$PATH`
...
#   2.1 Client-Specific:
#   --------------------
which_atom=$(which atom)
alias atom='$which_atom -w'                 # Usage:        Atom [files]
...
# PIP
export PIP_REQUIRE_VIRTUALENV=false         # pip should only run if there is a virtualenv currently activated
